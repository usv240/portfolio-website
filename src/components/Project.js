...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'A secure Android voting application using blockchain technology for voter authentication and data integrity.',
  ...
  return (
    <div id="projects" className="projects-container">
      ...
      {/* CTA Section for viewing more projects */}
      <div className="projects-footer">
        <a href="https://github.com/usv240" className="view-more-btn" target="_blank" rel="noopener noreferrer">
